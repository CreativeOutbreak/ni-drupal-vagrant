...
Vagrant.configure('2') do |config|
  ...
  # Run modulesetup shell script.
  #config.vm.provision "shell", path: "scripts/ni/d7modules.sh", args: config_json["vdd"]["sites"]["drupal7"]["modules"]


  # Run legacy db setup shell script.
  #config.vm.provision "shell", path: "scripts/ni/drupal_settings.sh", args: config_json["vdd"]["sites"]["drupal7"]["databases"]
